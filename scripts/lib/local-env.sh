...
MP_SOCKET_PATH="${MP_SOCKET_PATH:-$(mp_script_join_path "$MP_SCRIPT_DEFAULT_LOCAL_RUN_DIR" "mp-cache.sock")}"
MP_PID_FILE="${MP_PID_FILE:-$(mp_script_join_path "$MP_SCRIPT_DEFAULT_LOCAL_RUN_DIR" "mp-cache.pid")}"
